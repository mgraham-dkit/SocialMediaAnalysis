...
public class PostUserMap {
    ...
    private void updateMap() {
        ...
        for (int i = 0; i < oldMap.length; i++) {
            ...
            for (int j = 0; j < oldMap[i].size(); j++) {
                ...
                UserEngagementMap value = currentEntry.value;
    ...
    public UserEngagementMap put(String key, UserEngagementMap value) {
        // Validation
        if (key == null) {
        ...
        if (index != -1) {
            ...
            UserEngagementMap replaced = toBeUpdated.value;
    ...
    public UserEngagementMap get(String key) {
        // Validation
        if (key == null) {
            throw new IllegalArgumentException("Key cannot be null");
        }
    ...
    public UserEngagementMap[] getValues() {
        UserEngagementMap[] values = new UserEngagementMap[count];
        int valueCount = 0;
    ...
    private static class Entry{
        ...
        public Entry(String key, UserEngagementMap value) {
            this.key = key;
            this.value = value;
        }
